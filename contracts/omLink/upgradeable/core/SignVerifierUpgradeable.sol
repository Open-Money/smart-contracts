...
contract SignVerifierUpgradeable is Initializable {

    function __SignVerifier_init() public initializer {
        __SignVerifier_init_unchained();
    }

    function __SignVerifier_init_unchained() public initializer {
